...
#显示<__main__.Student object at 0x109afb190>
print(Student('Michael'))
#但是这样打印不好看，那怎么才能打印得好看呢
...
#3.__getitem__
#上面的Fib实例虽然能作用于for循环，看起来和list有点像
#但是，把它当成list来使用还是不行，比如，取第5个元素：
#rint(Fib()[5])	#TypeError: 'Fib' object does not support indexing
