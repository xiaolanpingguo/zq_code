...
void main()
{
	...
	std::cout<<sizeTN(tn1)<<std::endl;
	std::cout<<sizeTN(tn2)<<std::endl;
	std::cout<<sizeTN(tn3)<<std::endl;

	std::cout<<heightTN(tn1)<<std::endl;
	std::cout<<heightTN(tn2)<<std::endl;
	std::cout<<heightTN(tn3)<<std::endl;
