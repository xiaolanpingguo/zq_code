...
extern ?initLogicalProcessor@@YAXPEAX@Z : proc
extern ?return_rsp_for_vmxoff@@YA_KXZ : proc
extern ?return_rip_for_vmxoff@@YA_KXZ : proc

PUBLIC ?vmmEntrypoint@@YAXXZ
PUBLIC ?vmxRestoreState@@YAXXZ
PUBLIC ?vmxSaveState@@YAXXZ
...
exit:
    ...
    ret
?vmmEntrypoint@@YAXXZ endp

?vmxSaveState@@YAXXZ PROC
    pushfq
    SAVE_GP
    sub rsp, 020h
    mov rcx, rsp
    call ?initLogicalProcessor@@YAXPEAX@Z
    int 3 ; we should never be here

?vmxSaveState@@YAXXZ ENDP

?vmxRestoreState@@YAXXZ PROC
	add rsp, 020h
	RESTORE_GP
    popfq
	ret
?vmxRestoreState@@YAXXZ ENDP
