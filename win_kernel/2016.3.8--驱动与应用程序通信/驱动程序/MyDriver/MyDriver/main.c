//因为用的是VS2015，虚拟机是WIN7,所以要先要设置平台为WIN7平台，
//具体在项目属性--Driver--general里面
//F7编译成功后，主机打开windbg,把生成的.sys文件拖到虚拟机，打开driver manager和
//dbgview，在driver manager点击register，再点击RUN，可以看到DBGVIEW已经输出信息了
//那整个驱动就已经成功安装了
