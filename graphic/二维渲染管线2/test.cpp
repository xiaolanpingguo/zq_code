...
void GameRun(HWND hwnd)
{
	...
	::Rectangle(g_BackDC,99,99,401,401);
	CMatrix3 m1,m2,m3;
	m1.Translate(100,100);
	GetCameraMatrix(&m2,&CVector2(a,b),&CVector2(a + 100.0f, b - 100.0f));
	GetViewMatrix(&m3,300,300,100,100,300,300);

	SetMatrix(_WORLD_MATRIX,&m1);
	SetMatrix(_CAMERA_MATRIX,&m2);
	SetMatrix(_VIEW_MATRIX,&m3);

	DrawMODAL2D(&my_modal,g_BmpDC,100,100,400,400);
